...
$(ObjDir)/tb_image_inverter_BLIp.cpp_pre.cpp.tb.o : tb_image_inverter_BLIp.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_image_inverter_BLIp.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/image_inverter_BLIp.cpp_pre.cpp.tb.o : image_inverter_BLIp.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling image_inverter_BLIp.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
