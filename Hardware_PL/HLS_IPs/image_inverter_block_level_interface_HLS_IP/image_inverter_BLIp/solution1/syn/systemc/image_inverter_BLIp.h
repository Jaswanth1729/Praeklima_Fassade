...
#ifndef _image_inverter_BLIp_HH_
#define _image_inverter_BLIp_HH_
...
struct image_inverter_BLIp : public sc_module {
    ...
    // Module declarations
    image_inverter_BLIp(sc_module_name name);
    SC_HAS_PROCESS(image_inverter_BLIp);
