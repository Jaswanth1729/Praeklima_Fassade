...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.openhab_controls.autotvin_inputData_V.dat"
         "c.openhab_controls.autotvin_thresholds_V.dat"
         "c.openhab_controls.autotvin_outData.dat"
         "c.openhab_controls.autotvout_outData.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.openhab_controls.autotvout_outData.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
