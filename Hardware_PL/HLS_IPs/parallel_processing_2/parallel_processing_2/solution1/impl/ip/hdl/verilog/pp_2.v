...
(* CORE_GENERATION_INFO="pp_2,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.203000,HLS_SYN_LAT=23,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=67,HLS_SYN_LUT=145,HLS_VERSION=2019_2}" *)
...
reg   [0:0] icmp_ln14_reg_177;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln14_reg_177_pp0_iter1_reg;
reg   [4:0] idx_0_reg_115;
...
wire   [4:0] idx_fu_132_p2;
reg   [31:0] tmp_data_V_reg_186;
reg   [3:0] tmp_keep_V_reg_192;
reg   [3:0] tmp_strb_V_reg_197;
reg   [1:0] tmp_user_V_reg_202;
reg   [0:0] tmp_last_V_reg_207;
reg   [4:0] tmp_id_V_reg_212;
reg   [5:0] tmp_dest_V_reg_217;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] shl_ln68_fu_166_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln14_fu_126_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((icmp_ln14_fu_126_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln14_fu_126_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((((icmp_ln14_reg_177_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln14_reg_177 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln14_reg_177 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter1 == 1'b0) & (icmp_ln14_fu_126_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)) & ~((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)) | ((ap_enable_reg_pp0_iter1 == 1'b0) & (icmp_ln14_fu_126_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln14_fu_126_p2 == 1'd0) & (inStream_TVALID_int == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b1 == ap_block_state3_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln14_fu_126_p2 == 1'd0) & (inStream_TVALID_int == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b1 == ap_block_state3_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln14_fu_126_p2 == 1'd0) & (inStream_TVALID_int == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter0 = ((icmp_ln14_fu_126_p2 == 1'd0) & (inStream_TVALID_int == 1'b0));
end

always @ (*) begin
    ap_block_state3_io = ((icmp_ln14_reg_177 == 1'd0) & (outStream_TREADY_int == 1'b0));
end

assign ap_block_state3_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_io = ((icmp_ln14_reg_177_pp0_iter1_reg == 1'd0) & (outStream_TREADY_int == 1'b0));
end
...
assign icmp_ln14_fu_126_p2 = ((idx_0_reg_115 == 5'd20) ? 1'b1 : 1'b0);

assign idx_fu_132_p2 = (idx_0_reg_115 + 5'd1);

assign outStream_TDATA_int = (tmp_data_V_reg_186 + shl_ln68_fu_166_p2);

assign outStream_TVALID = regslice_both_outStream_V_data_V_U_vld_out;

assign shl_ln68_fu_166_p2 = tmp_data_V_reg_186 << 32'd2;
