...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "pp_2.autotvin.dat"
	set constFileTvOut       "pp_2.autotvout.dat"
	set constFileHdlTvIn     "pp_2.autohdltvin.dat"
	set constFileHdlTvOut    "pp_2.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
