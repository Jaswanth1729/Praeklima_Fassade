...
`define AUTOTB_DUT      pp_2
`define AUTOTB_DUT_INST AESL_inst_pp_2
`define AUTOTB_TOP      apatb_pp_2_top
`define AUTOTB_LAT_RESULT_FILE "pp_2.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "pp_2.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_pp_2_top
...
`define AUTOTB_TVIN_inStream_V_data_V  "./c.pp_2.autotvin_inStream_V_data_V.dat"
`define AUTOTB_TVIN_inStream_V_keep_V  "./c.pp_2.autotvin_inStream_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_V_strb_V  "./c.pp_2.autotvin_inStream_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_V_user_V  "./c.pp_2.autotvin_inStream_V_user_V.dat"
`define AUTOTB_TVIN_inStream_V_last_V  "./c.pp_2.autotvin_inStream_V_last_V.dat"
`define AUTOTB_TVIN_inStream_V_id_V  "./c.pp_2.autotvin_inStream_V_id_V.dat"
`define AUTOTB_TVIN_inStream_V_dest_V  "./c.pp_2.autotvin_inStream_V_dest_V.dat"
`define AUTOTB_TVIN_outStream_V_data_V  "./c.pp_2.autotvin_outStream_V_data_V.dat"
`define AUTOTB_TVIN_outStream_V_keep_V  "./c.pp_2.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V  "./c.pp_2.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_user_V  "./c.pp_2.autotvin_outStream_V_user_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V  "./c.pp_2.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_id_V  "./c.pp_2.autotvin_outStream_V_id_V.dat"
`define AUTOTB_TVIN_outStream_V_dest_V  "./c.pp_2.autotvin_outStream_V_dest_V.dat"
`define AUTOTB_TVIN_inStream_V_data_V_out_wrapc  "./rtl.pp_2.autotvin_inStream_V_data_V.dat"
`define AUTOTB_TVIN_inStream_V_keep_V_out_wrapc  "./rtl.pp_2.autotvin_inStream_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_V_strb_V_out_wrapc  "./rtl.pp_2.autotvin_inStream_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_V_user_V_out_wrapc  "./rtl.pp_2.autotvin_inStream_V_user_V.dat"
`define AUTOTB_TVIN_inStream_V_last_V_out_wrapc  "./rtl.pp_2.autotvin_inStream_V_last_V.dat"
`define AUTOTB_TVIN_inStream_V_id_V_out_wrapc  "./rtl.pp_2.autotvin_inStream_V_id_V.dat"
`define AUTOTB_TVIN_inStream_V_dest_V_out_wrapc  "./rtl.pp_2.autotvin_inStream_V_dest_V.dat"
`define AUTOTB_TVIN_outStream_V_data_V_out_wrapc  "./rtl.pp_2.autotvin_outStream_V_data_V.dat"
`define AUTOTB_TVIN_outStream_V_keep_V_out_wrapc  "./rtl.pp_2.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V_out_wrapc  "./rtl.pp_2.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_user_V_out_wrapc  "./rtl.pp_2.autotvin_outStream_V_user_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V_out_wrapc  "./rtl.pp_2.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_id_V_out_wrapc  "./rtl.pp_2.autotvin_outStream_V_id_V.dat"
`define AUTOTB_TVIN_outStream_V_dest_V_out_wrapc  "./rtl.pp_2.autotvin_outStream_V_dest_V.dat"
`define AUTOTB_TVOUT_outStream_V_data_V  "./c.pp_2.autotvout_outStream_V_data_V.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V  "./c.pp_2.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V  "./c.pp_2.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_user_V  "./c.pp_2.autotvout_outStream_V_user_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V  "./c.pp_2.autotvout_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_id_V  "./c.pp_2.autotvout_outStream_V_id_V.dat"
`define AUTOTB_TVOUT_outStream_V_dest_V  "./c.pp_2.autotvout_outStream_V_dest_V.dat"
`define AUTOTB_TVOUT_outStream_V_data_V_out_wrapc  "./impl_rtl.pp_2.autotvout_outStream_V_data_V.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V_out_wrapc  "./impl_rtl.pp_2.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V_out_wrapc  "./impl_rtl.pp_2.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_user_V_out_wrapc  "./impl_rtl.pp_2.autotvout_outStream_V_user_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V_out_wrapc  "./impl_rtl.pp_2.autotvout_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_id_V_out_wrapc  "./impl_rtl.pp_2.autotvout_outStream_V_id_V.dat"
`define AUTOTB_TVOUT_outStream_V_dest_V_out_wrapc  "./impl_rtl.pp_2.autotvout_outStream_V_dest_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 23;
parameter LENGTH_inStream_V_data_V = 20;
parameter LENGTH_inStream_V_keep_V = 20;
parameter LENGTH_inStream_V_strb_V = 20;
parameter LENGTH_inStream_V_user_V = 20;
parameter LENGTH_inStream_V_last_V = 20;
parameter LENGTH_inStream_V_id_V = 20;
parameter LENGTH_inStream_V_dest_V = 20;
parameter LENGTH_outStream_V_data_V = 20;
parameter LENGTH_outStream_V_keep_V = 20;
parameter LENGTH_outStream_V_strb_V = 20;
parameter LENGTH_outStream_V_user_V = 20;
parameter LENGTH_outStream_V_last_V = 20;
parameter LENGTH_outStream_V_id_V = 20;
parameter LENGTH_outStream_V_dest_V = 20;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.pp_2.autotvout_outStream_V_data_V.dat", "r");
    fp2 = $fopen("./impl_rtl.pp_2.autotvout_outStream_V_data_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.pp_2.autotvout_outStream_V_data_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.pp_2.autotvout_outStream_V_data_V.dat\"!");
    else begin
        $display("Comparing rtl.pp_2.autotvout_outStream_V_data_V.dat with impl_rtl.pp_2.autotvout_outStream_V_data_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.pp_2.autotvout_outStream_V_keep_V.dat", "r");
    fp2 = $fopen("./impl_rtl.pp_2.autotvout_outStream_V_keep_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.pp_2.autotvout_outStream_V_keep_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.pp_2.autotvout_outStream_V_keep_V.dat\"!");
    else begin
        $display("Comparing rtl.pp_2.autotvout_outStream_V_keep_V.dat with impl_rtl.pp_2.autotvout_outStream_V_keep_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.pp_2.autotvout_outStream_V_strb_V.dat", "r");
    fp2 = $fopen("./impl_rtl.pp_2.autotvout_outStream_V_strb_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.pp_2.autotvout_outStream_V_strb_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.pp_2.autotvout_outStream_V_strb_V.dat\"!");
    else begin
        $display("Comparing rtl.pp_2.autotvout_outStream_V_strb_V.dat with impl_rtl.pp_2.autotvout_outStream_V_strb_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.pp_2.autotvout_outStream_V_user_V.dat", "r");
    fp2 = $fopen("./impl_rtl.pp_2.autotvout_outStream_V_user_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.pp_2.autotvout_outStream_V_user_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.pp_2.autotvout_outStream_V_user_V.dat\"!");
    else begin
        $display("Comparing rtl.pp_2.autotvout_outStream_V_user_V.dat with impl_rtl.pp_2.autotvout_outStream_V_user_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.pp_2.autotvout_outStream_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.pp_2.autotvout_outStream_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.pp_2.autotvout_outStream_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.pp_2.autotvout_outStream_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.pp_2.autotvout_outStream_V_last_V.dat with impl_rtl.pp_2.autotvout_outStream_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.pp_2.autotvout_outStream_V_id_V.dat", "r");
    fp2 = $fopen("./impl_rtl.pp_2.autotvout_outStream_V_id_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.pp_2.autotvout_outStream_V_id_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.pp_2.autotvout_outStream_V_id_V.dat\"!");
    else begin
        $display("Comparing rtl.pp_2.autotvout_outStream_V_id_V.dat with impl_rtl.pp_2.autotvout_outStream_V_id_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.pp_2.autotvout_outStream_V_dest_V.dat", "r");
    fp2 = $fopen("./impl_rtl.pp_2.autotvout_outStream_V_dest_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.pp_2.autotvout_outStream_V_dest_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.pp_2.autotvout_outStream_V_dest_V.dat\"!");
    else begin
        $display("Comparing rtl.pp_2.autotvout_outStream_V_dest_V.dat with impl_rtl.pp_2.autotvout_outStream_V_dest_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
