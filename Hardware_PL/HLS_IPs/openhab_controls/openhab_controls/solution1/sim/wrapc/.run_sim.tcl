...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "openhab_controls.autotvin.dat"
	set constFileTvOut       "openhab_controls.autotvout.dat"
	set constFileHdlTvIn     "openhab_controls.autohdltvin.dat"
	set constFileHdlTvOut    "openhab_controls.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
