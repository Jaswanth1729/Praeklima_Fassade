...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "image_inverter1.autotvin.dat"
	set constFileTvOut       "image_inverter1.autotvout.dat"
	set constFileHdlTvIn     "image_inverter1.autohdltvin.dat"
	set constFileHdlTvOut    "image_inverter1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
