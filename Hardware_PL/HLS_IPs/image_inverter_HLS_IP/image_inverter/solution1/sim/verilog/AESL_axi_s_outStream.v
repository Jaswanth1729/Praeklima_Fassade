...
`define TV_OUT_outStream_TDATA "../tv/rtldatafile/rtl.image_inverter1.autotvout_outStream_V_data_V.dat"
`define EGRESS_STATUS_outStream_TDATA "../tv/stream_size/stream_egress_status_outStream_V_data_V.dat"
`define TV_OUT_outStream_TKEEP "../tv/rtldatafile/rtl.image_inverter1.autotvout_outStream_V_keep_V.dat"
`define EGRESS_STATUS_outStream_TKEEP "../tv/stream_size/stream_egress_status_outStream_V_keep_V.dat"
`define TV_OUT_outStream_TSTRB "../tv/rtldatafile/rtl.image_inverter1.autotvout_outStream_V_strb_V.dat"
`define EGRESS_STATUS_outStream_TSTRB "../tv/stream_size/stream_egress_status_outStream_V_strb_V.dat"
`define TV_OUT_outStream_TLAST "../tv/rtldatafile/rtl.image_inverter1.autotvout_outStream_V_last_V.dat"
...
module AESL_axi_s_outStream (
    ...
    fifo #(1000, 8) fifo_outStream_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1000, 1) fifo_outStream_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1000, 1) fifo_outStream_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
