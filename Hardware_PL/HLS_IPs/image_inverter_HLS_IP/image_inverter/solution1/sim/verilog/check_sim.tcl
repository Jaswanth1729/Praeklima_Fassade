...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.image_inverter1.autotvin_inStream_V_data_V.dat"
         "c.image_inverter1.autotvin_inStream_V_keep_V.dat"
         "c.image_inverter1.autotvin_inStream_V_strb_V.dat"
         "c.image_inverter1.autotvin_inStream_V_last_V.dat"
         "c.image_inverter1.autotvin_outStream_V_data_V.dat"
         "c.image_inverter1.autotvin_outStream_V_keep_V.dat"
         "c.image_inverter1.autotvin_outStream_V_strb_V.dat"
         "c.image_inverter1.autotvin_outStream_V_last_V.dat"
         "c.image_inverter1.autotvout_outStream_V_data_V.dat"
         "c.image_inverter1.autotvout_outStream_V_keep_V.dat"
         "c.image_inverter1.autotvout_outStream_V_strb_V.dat"
         "c.image_inverter1.autotvout_outStream_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.image_inverter1.autotvout_outStream_V_data_V.dat"
         "rtl.image_inverter1.autotvout_outStream_V_keep_V.dat"
         "rtl.image_inverter1.autotvout_outStream_V_strb_V.dat"
         "rtl.image_inverter1.autotvout_outStream_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
