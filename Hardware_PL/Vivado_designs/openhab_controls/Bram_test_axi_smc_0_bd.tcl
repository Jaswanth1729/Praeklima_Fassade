...
################################################################
# This is a generated script based on design: bd_11eb
#
...
proc create_hier_cell_s03_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG001_BASE_ADDR {0x00000000A0000000} \
   ...
   CONFIG.SEG002_BASE_ADDR {0x00000000A0002000} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.MSC005_RDATA_WIDTH {128} \
   CONFIG.MSC005_WDATA_WIDTH {128} \
   CONFIG.NUM_MSC {6} \
   CONFIG.NUM_READ_OUTSTANDING {2} \
...
proc create_hier_cell_s01_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG000_SUPPORTS_READ {1} \
   CONFIG.SEG000_SUPPORTS_WRITE {1} \
   CONFIG.SEG001_BASE_ADDR {0x00000000A0002000} \
   CONFIG.SEG001_SECURE_READ {0} \
   CONFIG.SEG001_SECURE_WRITE {0} \
   ...
   CONFIG.SEG001_SUPPORTS_READ {1} \
   CONFIG.SEG001_SUPPORTS_WRITE {1} \
   CONFIG.SEG002_BASE_ADDR {0x00000000A0010000} \
   CONFIG.SEG002_SECURE_READ {0} \
   CONFIG.SEG002_SECURE_WRITE {0} \
   ...
   CONFIG.SEG002_SUPPORTS_READ {1} \
   CONFIG.SEG002_SUPPORTS_WRITE {1} \
   CONFIG.SEG003_BASE_ADDR {0x00000000A0020000} \
   ...
   CONFIG.SEG004_BASE_ADDR {0x00000000A0030000} \
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net clk_map_aclk_net [get_bd_pins M00_ACLK] [get_bd_pins M01_ACLK] [get_bd_pins M02_ACLK] [get_bd_pins M03_ACLK] [get_bd_pins M04_ACLK] [get_bd_pins M05_ACLK] [get_bd_pins S00_ACLK] [get_bd_pins S01_ACLK] [get_bd_pins S02_ACLK] [get_bd_pins S03_ACLK] [get_bd_pins aclk] [get_bd_pins swbd_aclk] [get_bd_pins psr_aclk/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk_interconnect_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins M01_ARESETN] [get_bd_pins M02_ARESETN] [get_bd_pins M03_ARESETN] [get_bd_pins M04_ARESETN] [get_bd_pins M05_ARESETN] [get_bd_pins S00_ARESETN] [get_bd_pins S01_ARESETN] [get_bd_pins S02_ARESETN] [get_bd_pins S03_ARESETN] [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M00_AXI:M01_AXI:M02_AXI:M03_AXI:M04_AXI:M05_AXI:S00_AXI:S01_AXI:S02_AXI:S03_AXI} \
 ] $aclk
  ...
  connect_bd_intf_net -intf_net S_SC_AW_8 [get_bd_intf_pins m04_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M04_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_9 [get_bd_intf_pins m05_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M05_SC_AW]
  ...
  connect_bd_intf_net -intf_net S_SC_B_8 [get_bd_intf_pins m04_nodes/S_SC_B] [get_bd_intf_pins m04_sc2axi/M_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_9 [get_bd_intf_pins m05_nodes/S_SC_B] [get_bd_intf_pins m05_sc2axi/M_SC_B]
  ...
  connect_bd_intf_net -intf_net S_SC_W_8 [get_bd_intf_pins m04_nodes/S_SC_W] [get_bd_intf_pins switchboards/M04_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_9 [get_bd_intf_pins m05_nodes/S_SC_W] [get_bd_intf_pins switchboards/M05_SC_W]
