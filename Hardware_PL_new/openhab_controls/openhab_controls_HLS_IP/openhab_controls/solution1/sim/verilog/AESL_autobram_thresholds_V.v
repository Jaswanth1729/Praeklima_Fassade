...
module AESL_autobram_thresholds_V (
    Clk_A,
    Rst_A,
    EN_A,
    WEN_A,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.openhab_controls.autotvin_thresholds_V.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.openhab_controls.autotvout_thresholds_V.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 32;
parameter DEPTH = 32'd 50;
