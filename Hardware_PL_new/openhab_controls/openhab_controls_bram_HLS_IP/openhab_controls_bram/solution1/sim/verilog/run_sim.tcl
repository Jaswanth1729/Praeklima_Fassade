...
if {[file isfile openhab_controls.autotvin.dat]} {
	file delete -force openhab_controls.autotvin.dat
}

if {[file isfile openhab_controls.autotvout.dat]} {
	file delete -force openhab_controls.autotvout.dat
}
