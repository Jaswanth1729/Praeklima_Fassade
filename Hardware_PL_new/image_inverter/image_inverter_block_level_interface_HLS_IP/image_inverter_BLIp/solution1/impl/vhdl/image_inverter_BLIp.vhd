...
architecture behav of image_inverter_BLIp is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "image_inverter_BLIp,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=0.389000,HLS_SYN_LAT=1,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2,HLS_SYN_LUT=34,HLS_VERSION=2019_2}";
...
begin
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, regslice_both_outStream_V_data_V_U_apdone_blk, inStream_TVALID_int)
    begin
                ap_block_pp0_stage0_01001 <= (((regslice_both_outStream_V_data_V_U_apdone_blk = ap_const_logic_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_start = ap_const_logic_0) or (inStream_TVALID_int = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, regslice_both_outStream_V_data_V_U_apdone_blk, inStream_TVALID_int, outStream_TREADY_int)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((outStream_TREADY_int = ap_const_logic_0) or (regslice_both_outStream_V_data_V_U_apdone_blk = ap_const_logic_1))) or ((ap_start = ap_const_logic_1) and ((ap_start = ap_const_logic_0) or (outStream_TREADY_int = ap_const_logic_0) or (inStream_TVALID_int = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, regslice_both_outStream_V_data_V_U_apdone_blk, inStream_TVALID_int, outStream_TREADY_int)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((outStream_TREADY_int = ap_const_logic_0) or (regslice_both_outStream_V_data_V_U_apdone_blk = ap_const_logic_1))) or ((ap_start = ap_const_logic_1) and ((ap_start = ap_const_logic_0) or (outStream_TREADY_int = ap_const_logic_0) or (inStream_TVALID_int = ap_const_logic_0))));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(ap_start, inStream_TVALID_int)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_start = ap_const_logic_0) or (inStream_TVALID_int = ap_const_logic_0));
    end process;
    ...
    inStream_TDATA_blk_n_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, inStream_TVALID_int)
    begin
    ...
    inStream_TREADY_int_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    outStream_TDATA_blk_n_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, outStream_TREADY_int)
    begin
    ...
    outStream_TVALID_int_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
