...
`define TV_IN_inStream_TDATA "./c.image_inverter_BLIp.autotvin_inStream_V_data_V.dat"
`define INGRESS_STATUS_inStream_TDATA "./stream_ingress_status_inStream_V_data_V.dat"
`define TV_IN_inStream_TKEEP "./c.image_inverter_BLIp.autotvin_inStream_V_keep_V.dat"
`define INGRESS_STATUS_inStream_TKEEP "./stream_ingress_status_inStream_V_keep_V.dat"
`define TV_IN_inStream_TSTRB "./c.image_inverter_BLIp.autotvin_inStream_V_strb_V.dat"
`define INGRESS_STATUS_inStream_TSTRB "./stream_ingress_status_inStream_V_strb_V.dat"
`define TV_IN_inStream_TLAST "./c.image_inverter_BLIp.autotvin_inStream_V_last_V.dat"
