...
`define AUTOTB_DUT      image_inverter_BLIp
`define AUTOTB_DUT_INST AESL_inst_image_inverter_BLIp
`define AUTOTB_TOP      apatb_image_inverter_BLIp_top
`define AUTOTB_LAT_RESULT_FILE "image_inverter_BLIp.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "image_inverter_BLIp.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_image_inverter_BLIp_top
...
`define AUTOTB_TVIN_inStream_V_data_V  "./c.image_inverter_BLIp.autotvin_inStream_V_data_V.dat"
`define AUTOTB_TVIN_inStream_V_keep_V  "./c.image_inverter_BLIp.autotvin_inStream_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_V_strb_V  "./c.image_inverter_BLIp.autotvin_inStream_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_V_last_V  "./c.image_inverter_BLIp.autotvin_inStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_data_V  "./c.image_inverter_BLIp.autotvin_outStream_V_data_V.dat"
`define AUTOTB_TVIN_outStream_V_keep_V  "./c.image_inverter_BLIp.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V  "./c.image_inverter_BLIp.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V  "./c.image_inverter_BLIp.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVIN_inStream_V_data_V_out_wrapc  "./rtl.image_inverter_BLIp.autotvin_inStream_V_data_V.dat"
`define AUTOTB_TVIN_inStream_V_keep_V_out_wrapc  "./rtl.image_inverter_BLIp.autotvin_inStream_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_V_strb_V_out_wrapc  "./rtl.image_inverter_BLIp.autotvin_inStream_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_V_last_V_out_wrapc  "./rtl.image_inverter_BLIp.autotvin_inStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_data_V_out_wrapc  "./rtl.image_inverter_BLIp.autotvin_outStream_V_data_V.dat"
`define AUTOTB_TVIN_outStream_V_keep_V_out_wrapc  "./rtl.image_inverter_BLIp.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V_out_wrapc  "./rtl.image_inverter_BLIp.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V_out_wrapc  "./rtl.image_inverter_BLIp.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_data_V  "./c.image_inverter_BLIp.autotvout_outStream_V_data_V.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V  "./c.image_inverter_BLIp.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V  "./c.image_inverter_BLIp.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V  "./c.image_inverter_BLIp.autotvout_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_data_V_out_wrapc  "./impl_rtl.image_inverter_BLIp.autotvout_outStream_V_data_V.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V_out_wrapc  "./impl_rtl.image_inverter_BLIp.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V_out_wrapc  "./impl_rtl.image_inverter_BLIp.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V_out_wrapc  "./impl_rtl.image_inverter_BLIp.autotvout_outStream_V_last_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1;
parameter LENGTH_inStream_V_data_V = 1;
parameter LENGTH_inStream_V_keep_V = 1;
parameter LENGTH_inStream_V_strb_V = 1;
parameter LENGTH_inStream_V_last_V = 1;
parameter LENGTH_outStream_V_data_V = 1;
parameter LENGTH_outStream_V_keep_V = 1;
parameter LENGTH_outStream_V_strb_V = 1;
parameter LENGTH_outStream_V_last_V = 1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.image_inverter_BLIp.autotvout_outStream_V_data_V.dat", "r");
    fp2 = $fopen("./impl_rtl.image_inverter_BLIp.autotvout_outStream_V_data_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.image_inverter_BLIp.autotvout_outStream_V_data_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.image_inverter_BLIp.autotvout_outStream_V_data_V.dat\"!");
    else begin
        $display("Comparing rtl.image_inverter_BLIp.autotvout_outStream_V_data_V.dat with impl_rtl.image_inverter_BLIp.autotvout_outStream_V_data_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.image_inverter_BLIp.autotvout_outStream_V_keep_V.dat", "r");
    fp2 = $fopen("./impl_rtl.image_inverter_BLIp.autotvout_outStream_V_keep_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.image_inverter_BLIp.autotvout_outStream_V_keep_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.image_inverter_BLIp.autotvout_outStream_V_keep_V.dat\"!");
    else begin
        $display("Comparing rtl.image_inverter_BLIp.autotvout_outStream_V_keep_V.dat with impl_rtl.image_inverter_BLIp.autotvout_outStream_V_keep_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.image_inverter_BLIp.autotvout_outStream_V_strb_V.dat", "r");
    fp2 = $fopen("./impl_rtl.image_inverter_BLIp.autotvout_outStream_V_strb_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.image_inverter_BLIp.autotvout_outStream_V_strb_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.image_inverter_BLIp.autotvout_outStream_V_strb_V.dat\"!");
    else begin
        $display("Comparing rtl.image_inverter_BLIp.autotvout_outStream_V_strb_V.dat with impl_rtl.image_inverter_BLIp.autotvout_outStream_V_strb_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.image_inverter_BLIp.autotvout_outStream_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.image_inverter_BLIp.autotvout_outStream_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.image_inverter_BLIp.autotvout_outStream_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.image_inverter_BLIp.autotvout_outStream_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.image_inverter_BLIp.autotvout_outStream_V_last_V.dat with impl_rtl.image_inverter_BLIp.autotvout_outStream_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
