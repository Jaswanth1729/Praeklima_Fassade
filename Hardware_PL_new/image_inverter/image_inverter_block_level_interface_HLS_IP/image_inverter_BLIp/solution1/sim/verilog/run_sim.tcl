...
if {[file isfile image_inverter_BLIp.autotvin.dat]} {
	file delete -force image_inverter_BLIp.autotvin.dat
}

if {[file isfile image_inverter_BLIp.autotvout.dat]} {
	file delete -force image_inverter_BLIp.autotvout.dat
}
