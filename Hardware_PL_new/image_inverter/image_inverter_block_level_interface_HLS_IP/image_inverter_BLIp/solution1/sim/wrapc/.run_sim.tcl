...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/jaswanth/toolsEDA/Xilinx/Vivado/2019.2/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/jaswanth/toolsEDA/Xilinx/Vivado/2019.2/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/jaswanth/toolsEDA/Xilinx/Vivado/2019.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/jaswanth/toolsEDA/Xilinx/Vivado/2019.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/jaswanth/toolsEDA/Xilinx/Vivado/2019.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "image_inverter_BLIp.autotvin.dat"
	set constFileTvOut       "image_inverter_BLIp.autotvout.dat"
	set constFileHdlTvIn     "image_inverter_BLIp.autohdltvin.dat"
	set constFileHdlTvOut    "image_inverter_BLIp.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
