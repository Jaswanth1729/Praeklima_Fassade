...
(* CORE_GENERATION_INFO="image_inverter_BLIp,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=0.389000,HLS_SYN_LAT=1,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2,HLS_SYN_LUT=34,HLS_VERSION=2019_2}" *)
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((regslice_both_outStream_V_data_V_U_apdone_blk == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_start == 1'b0) | (inStream_TVALID_int == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & ((outStream_TREADY_int == 1'b0) | (regslice_both_outStream_V_data_V_U_apdone_blk == 1'b1))) | ((ap_start == 1'b1) & ((ap_start == 1'b0) | (outStream_TREADY_int == 1'b0) | (inStream_TVALID_int == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter1 == 1'b1) & ((outStream_TREADY_int == 1'b0) | (regslice_both_outStream_V_data_V_U_apdone_blk == 1'b1))) | ((ap_start == 1'b1) & ((ap_start == 1'b0) | (outStream_TREADY_int == 1'b0) | (inStream_TVALID_int == 1'b0))));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_start == 1'b0) | (inStream_TVALID_int == 1'b0));
end
