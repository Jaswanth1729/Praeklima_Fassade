...
`define TV_IN_inStream_TDATA "../tv/cdatafile/c.image_inverter1.autotvin_inStream_V_data_V.dat"
`define INGRESS_STATUS_inStream_TDATA "../tv/stream_size/stream_ingress_status_inStream_V_data_V.dat"
`define TV_IN_inStream_TKEEP "../tv/cdatafile/c.image_inverter1.autotvin_inStream_V_keep_V.dat"
`define INGRESS_STATUS_inStream_TKEEP "../tv/stream_size/stream_ingress_status_inStream_V_keep_V.dat"
`define TV_IN_inStream_TSTRB "../tv/cdatafile/c.image_inverter1.autotvin_inStream_V_strb_V.dat"
`define INGRESS_STATUS_inStream_TSTRB "../tv/stream_size/stream_ingress_status_inStream_V_strb_V.dat"
`define TV_IN_inStream_TLAST "../tv/cdatafile/c.image_inverter1.autotvin_inStream_V_last_V.dat"
...
module AESL_axi_s_inStream (
    ...
    fifo #(1000, 8) fifo_inStream_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1000, 1) fifo_inStream_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1000, 1) fifo_inStream_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
