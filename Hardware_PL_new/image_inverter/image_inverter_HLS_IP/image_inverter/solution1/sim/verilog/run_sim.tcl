...
if {[file isfile image_inverter1.autotvin.dat]} {
	file delete -force image_inverter1.autotvin.dat
}

if {[file isfile image_inverter1.autotvout.dat]} {
	file delete -force image_inverter1.autotvout.dat
}
