...
proc create_root_design { parentCell } {
  ...
  # Create instance: image_inverter1_0, and set properties
  set image_inverter1_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:image_inverter1:1.0 image_inverter1_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins image_inverter1_0/inStream]
  ...
  connect_bd_intf_net -intf_net image_inverter1_0_outStream [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins image_inverter1_0/outStream]
